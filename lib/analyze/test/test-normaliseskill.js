...
assertEqual(
  normalizeInferredSkills([
    { skill: "REST APIs", reason: "mentioned" },
    { skill: "   Hooks  ", reason: "pattern" },
  ]),
  [
    { skill: "rest apis", reason: "mentioned" },
    { skill: "hooks", reason: "pattern" },
  ],
  "Inferred normalization preserves reason"
);
...
assertEqual(
  normalizeInferredSkills([{ skill: "React" }, { skill: "React", reason: "" }]),
  [
    { skill: "react", reason: "" },
    { skill: "react", reason: "" },
  ],
...
const fullInput = {
  ...
  inferredSkills: [
    { skill: "REST  APIs", reason: "mentioned in text" },
    { skill: "react", reason: "weak match" },
    { skill: "   " },
  ],
};

const fullOutput = normalizeSkills(fullInput);
