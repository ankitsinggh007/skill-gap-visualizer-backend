...
const layerDTests = {
  ...
  "3. CHAOTIC TYPOS & BROKEN LANGUAGE": {
    ...
    extractedSkills: [],
    inferredSkills: [
      { skill: "React Router", reason: "ruter flwo" },
      { skill: "Hooks", reason: "ustate / ueffeect" },
      { skill: "JSX", reason: "jex" },
      { skill: "Query Libraries (React Query)", reason: "qury lib" },
      { skill: "State Management Patterns", reason: "glbal stoer" },
    ],
  },
