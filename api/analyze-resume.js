 ...
 */
export function createHandler({ analyzeResumeFn }) {
  if (typeof analyzeResumeFn !== "function") {
    throw new Error("createHandler requires analyzeResumeFn");
  }
...
const handler = createHandler({ analyzeResumeFn: analyzeResume });
